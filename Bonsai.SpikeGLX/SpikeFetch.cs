...
namespace Bonsai.SpikeGLX
{
    ...
    public class SpikeFetch : Source<Mat>
    {
        ...
        /// to a voltage, in mV.
        /// </summary>
        [Description("Flag to convert the fetched data from a unitless quantity to a voltage, in mV.")]
        ...
        {
            return Observable
                .Using<Mat, SpikeGLXDataStream>(() => new SpikeGLXDataStream(Host, Port, JS, IP, Channels),
                    connection => source
                        .Select(input =>
                        {
